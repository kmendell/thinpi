...
uint32 g_requested_session_width = 1280;
uint32 g_requested_session_height = 720;
...
usage(char *program)
{
	fprintf(stderr, "---------------------------\n");
	fprintf(stderr, "---------------------------\n");
	fprintf(stderr, "tprdp previously rdesktop\n");
	fprintf(stderr,
		"Version " PACKAGE_VERSION ". Copyright (C) 2021 Kyle Mendell\n");
